...
function () {
  ...
  return newProcess;
};var _deep_cyclic_copy;function _load_deep_cyclic_copy() {return _deep_cyclic_copy = _interopRequireDefault(require('./deep_cyclic_copy'));}function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}const BLACKLIST = new Set(['env', 'mainModule', '_events']); // The "process.env" object has a bunch of particularities: first, it does not
 ...
 *
 * 
 */function createProcessEnv() {// $FlowFixMe: Apparently Flow does not understand that this is a prototype.
